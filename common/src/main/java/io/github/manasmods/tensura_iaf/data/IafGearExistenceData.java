...
public class IafGearExistenceData {
	public static void bootstrap(BootstrapContext<GearExistenceData> context) {
		register(context, GearExistenceData.getDefault(IafItems.STYMPHALIAN_DAGGER.getId(), 1000, 0.01, UniqueGearEvolutionHelper.getLowMagisteelWeapons()));
		...
		for (SeaSerpentType seaSerpent : SeaSerpentType.values()) {
			...
			register(context, GearExistenceData.getDefault(seaSerpent.boots.getId(), 8000, 0.025, UniqueGearEvolutionHelper.getHighMagisteelArmors()));
		}

		for (TrollType troll : TrollType.values()) {
			register(context, GearExistenceData.getDefault(troll.helmet.getId(), 5000, 0.02, UniqueGearEvolutionHelper.getHighMagisteelArmors()));
			register(context, GearExistenceData.getDefault(troll.chestplate.getId(), 5000, 0.02, UniqueGearEvolutionHelper.getHighMagisteelArmors()));
			register(context, GearExistenceData.getDefault(troll.leggings.getId(), 5000, 0.02, UniqueGearEvolutionHelper.getHighMagisteelArmors()));
			register(context, GearExistenceData.getDefault(troll.boots.getId(), 5000, 0.02, UniqueGearEvolutionHelper.getHighMagisteelArmors()));
		}
		for (TrollType.BuiltinWeapon troll : TrollType.BuiltinWeapon.values()) {
			register(context, GearExistenceData.getDefault(troll.getItem().arch$registryName(), 5000, 0.02, UniqueGearEvolutionHelper.getHighMagisteelWeapons()));
		}

		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_SWORD.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_PICKAXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_SHOVEL.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_AXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_HOE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_HELMET.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_CHESTPLATE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_LEGGINGS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_FIRE_BOOTS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));

		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_SWORD.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_PICKAXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_SHOVEL.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_AXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_HOE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_HELMET.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_CHESTPLATE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_LEGGINGS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_ICE_BOOTS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));

		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_SWORD.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_PICKAXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_SHOVEL.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_AXE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_HOE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelWeapons()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_HELMET.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_CHESTPLATE.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_LEGGINGS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
		register(context, GearExistenceData.getDefault(IafItems.DRAGONSTEEL_LIGHTNING_BOOTS.getId(), 48000, 0.03, UniqueGearEvolutionHelper.getPureMagisteelArmors()));
	}
